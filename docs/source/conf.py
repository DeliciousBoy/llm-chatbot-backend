...
# llm_chatbot_backend documentation build
...
from llm_chatbot_backend import __version__ as release

# -- Project information -----------------------------------------------------

project = "llm_chatbot_backend"
author = "Kedro"
...
htmlhelp_basename = "llm_chatbot_backenddoc"
...
latex_documents = [
    (
        master_doc,
        "llm_chatbot_backend.tex",
        "llm_chatbot_backend Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "llm_chatbot_backend",
        "Project llm_chatbot_backend codebase.",
        "Data-Science",
    )
]
